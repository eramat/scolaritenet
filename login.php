...
function choix_type_login() {
    ...
    $req = "select ut.id_type, t.libelle
            ...
            where u.login = ? and u.password=? and ut.id_type=t.id_type and ut.id_user=u.id_user";
...
function est_utilisateur_actif($login) {
    ...
    $rep = $DB->GetOne("select id_user from ".$prefix_tables."users where login='".$login."' and actif=1");
    return $rep;
}
